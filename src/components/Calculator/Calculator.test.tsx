...
describe('mounted Calculator', () => {
  ...
  it('calls updateDisplay when a number key is clicked', () => {
    const spy = jest.spyOn(wrapper.instance() as Calculator, 'updateDisplay');
    wrapper.instance().forceUpdate(); // TODO: why is forceUpdate() exactly needed?
  ...
  it('calls setOperator when an operator key is clicked', () => {
    const spy = jest.spyOn(wrapper.instance() as Calculator, 'setOperator');
    wrapper.instance().forceUpdate(); // TODO: why is forceUpdate() exactly needed?
    expect(spy).toHaveBeenCalledTimes(0);
    wrapper
      .find('.operator-key')
  ...
  it('calls callOperator when the submit key is clicked', () => {
    const spy = jest.spyOn(wrapper.instance() as Calculator, 'callOperator');
    wrapper.instance().forceUpdate(); // TODO: why is forceUpdate() exactly needed?
    expect(spy).toHaveBeenCalledTimes(0);
...
describe('updateDisplay', () => {
  ...
  it('updates the displayValue', () => {
    (wrapper.instance() as Calculator).updateDisplay('5');
    expect(wrapper.state('displayValue')).toEqual('5');
  });

  it('concatenates displayValue', () => {
    (wrapper.instance() as Calculator).updateDisplay('5');
    (wrapper.instance() as Calculator).updateDisplay('0');
  ...
  it('removes last char of displayValue', () => {
    (wrapper.instance() as Calculator).updateDisplay('5');
    (wrapper.instance() as Calculator).updateDisplay('0');
    (wrapper.instance() as Calculator).updateDisplay('ce');
    expect(wrapper.state('displayValue')).toEqual('5');
  });

  it('prevents multiple instances of "." in displayValue', () => {
    (wrapper.instance() as Calculator).updateDisplay('.');
    (wrapper.instance() as Calculator).updateDisplay('.');
...
describe('setOperator', () => {
  ...
  it('updates the value of selectedOperator', () => {
    (wrapper.instance() as Calculator).setOperator('+');
...
describe('callOperator', () => {
  ...
  it('updates displayValue to the sum of storedValue and displayValue', () => {
    ...
    (wrapper.instance() as Calculator).callOperator();
    expect(wrapper.state('displayValue')).toEqual('5');
  });
